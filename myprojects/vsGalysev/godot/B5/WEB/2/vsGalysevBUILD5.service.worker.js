...
/** @type {string} */
const CACHE_VERSION = '1771176174|177989788';
/** @type {string} */
const CACHE_PREFIX = 'vs. Galysev-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'vsGalysevBUILD5.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["vsGalysevBUILD5.html","vsGalysevBUILD5.js","vsGalysevBUILD5.offline.html","vsGalysevBUILD5.icon.png","vsGalysevBUILD5.apple-touch-icon.png","vsGalysevBUILD5.audio.worklet.js","vsGalysevBUILD5.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["vsGalysevBUILD5.wasm","vsGalysevBUILD5.pck"];
